...
<html lang="en">
	...
	<body background="img/parhitean/parhitean1 (3).jpg" style="background-size:cover;">
		<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
			  <div class="form">
				<!-- the input -->
			  <div class="first-row">
					<a href="index.php"><img src="img/toba.jpg" alt="login" class="icon-login"></a>
