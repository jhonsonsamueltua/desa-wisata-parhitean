	...
	<body>
		...
		<div class="container">
			<div class="about">
				<div class="row">
					<div class="col-md-12">
						<h3>Komentar</h3><hr class="pg-titl-bdr-bta"></hr>
						<?php
						...
						<div class="col-md-4">
							...
							<center>
								<a href="tanggapan.php?items_id=<?=$items['id_aduan']?>"><button class="btn btn-info">Tanggapi</button></a>
							</center><br>
