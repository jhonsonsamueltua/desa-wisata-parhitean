<header>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="col-md-6">
					<a href="index.php"><img src="img/toba.jpg" class="img-responsive" style="width: 110px;"></a>
				</div>
				<div class="container">
				<div class="col-md-6">
						<div class="top">
							<div class="top-menu">
									...
									$role = $_SESSION['role'];
											...
											{
												echo '<ul><li><a href="index.php?do_logout"><i class="fa fa-sign-out"> LOGOUT</i><a></li>(Admin) </ul>';
											}
									}
									else {
											echo '<ul>
