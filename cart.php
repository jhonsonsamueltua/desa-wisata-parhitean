...
<html lang="en">
	<head>
		...
		<title>Keranjang | Parhitean</title>
        ...
        <div class="col-md-12">
          <div class="about">
            <div class="panel panel-heading">
				<h3>DESKRIPSI PEMESANAN ANDA</h3><hr class="pg-titl-bdr-bta"></hr>
			</div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <table class="table">
                              <tr><td> <h4>Nama Paket</h4></td>
                                <td><h4><?=$produk['nama']?></h4></td>
                              </tr>
                              <tr> <td><h4>Harga Paket</h4></td>
                                <td><h4>Rp <?=number_format($produk['harga'])?>.00</h4></td>
                              </tr>
                              <tr><td> <h4>Jumlah Paket</h4></td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="prbli.php?trans=1" method="post">
			  ...
			  <h5><input type="checkbox" required> Saya yakin ingin melakukan pemesanan</h5>
			  <center>
