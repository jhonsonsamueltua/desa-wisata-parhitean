...
<html lang="en">
	<head>
		...
		<title>Komentar | Parhitean</title>
		...
		<div class="container">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="komentar">
							<h3>KIRIMKAN KOMENTAR</h3><hr class="pg-titl-bdr-bta"></hr>
							<form action="help_process.php" method="post" role="form">
								...
								<div class="text-center"><button type="submit" class="btn btn-komentar btn-lg">Kirim Komentar</button></div>
							</form>
						</div>
					</div>
				</div>
