        ...
        <div class="col-md-12">
          <div class="transaksi">
						<div class="panel panel-heading">
							...
							<?php
							 ...
							 ?>
									...
									<p>Nomor Pesanan <font color="red">*</font> : <?=$tran['id_transaksi']?></p>
						 			<p>Tanggal Transaksi : <?=$tran['tanggal_transaksi']?></p>
						 			<p>Alamat Pemesan : <?=$tran['alamat_tujuan']?></p>
						 			<p>Identitas Pemesan : <?=$tran['identitas_penerima']?></p>
						...
						<div class="col-md-4">
							...
							<h4>No Rekening : 107 - 0011 - 714120</h4>
							<h4>Atas Nama : Tobasa Parhitean Rafting</h4>
						 </div>
						 <div class="col-md-4">
							<img src="img/bni.png"><br><br>
							<h4>No Rekening : 3829 - 01 - 018578 - 53 - 7</h4>
							<h4>Atas Nama : Tobasa Parhitean Rafting</h4>
						 </div>
						 <div class="col-md-4">
						...
						<font color="red">*</font> Gunakan Nomor Pesanan untuk proses pembayaran.<br><br>
						</div>
					</div>
					</div>
