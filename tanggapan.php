...
<html lang="en">
	<head>
		...
		<title>Aduan Layanan | Parhitean</title>
	...
	<body>
		...
		<div class="container">
			...
			$show = mysqli_query($conn, "SELECT * FROM komentar WHERE id_aduan='$id'");
				...
				<div class="row">
					<div class="col-md-12">
						<div class="komentar">
							...
							<form action="tanggapan_process.php?id_aduan=<?php echo $id ?> " method="post" role="form">
