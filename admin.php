...
<html lang="en">
	...
	<body>
		...
		<section class="product">
			<div class="container">
				<div class="row">
					<h3>DAFTAR PAKET RAFTING ANDA</h3><hr class="pg-titl-bdr-btad"></hr>
					<a href="tambah_produk.php">
						<button class="btn btn-tambah"><i class="fa fa-plus-circle"> Tambah Paket</i></button>
					</a>
					<div class="col-md-12">
					<?php
